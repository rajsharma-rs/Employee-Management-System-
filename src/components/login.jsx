      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="flex justify-center mb-8 animate-scale-in">
          <div className="flex items-center gap-2">
            ...
            <span className="text-3xl font-bold text-white">EMPLOYE MANAGEMENT SYSTEM</span>
          </div>
        </div>
            ...
            <div className="flex items-center justify-between animate-fade-in-up delay-400">
              <div className="flex items-center gap-2">
                <input
                  type="checkbox"
                  id="remember"
                  className="w-4 h-4 bg-slate-900/50 border-slate-700/50 rounded text-teal-500 focus:ring-2 focus:ring-teal-500/20"
                />
